...
# ── TCS — REMOVED from CRM (Section 206C(1F)) ────────────────
# TCS logic has been removed from GoldTrader Pro CRM.
# These constants and function are kept to avoid import errors in
# existing report endpoints but always return zero.
...
def calculate_tcs(subtotal: Decimal, pay_mode: str) -> dict[str, Decimal]:
    """TCS removed from CRM. Always returns zero."""
    return {
