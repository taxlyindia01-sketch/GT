...
async def list_payments(
    ...
    """List all payments for the tenant with customer name and invoice number."""
    tenant_id = payload["tenant_id"]
    stmt = (
        select(Payment)
    ...
    # FIX #1: Batch-load invoice data for customer_name and invoice_no
    ...
    return [{
        ...
        "customer_name":   inv_map.get(p.invoice_id, {}).get("name", ""),  # FIX #1
