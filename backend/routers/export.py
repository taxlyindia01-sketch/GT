...
async def export_supplier_all_excel(
    ...
    _pie.series[0].data_points = [
        DataPoint(idx=0, solidFill="4CAF50"),  # green = paid
        DataPoint(idx=1, solidFill="F44336"),  # red = outstanding
    ]
...
async def export_all_reports_excel(
    ...
    _pieB.series[0].data_points = [
        DataPoint(idx=0, solidFill="4CAF50"),   # green = paid
        DataPoint(idx=1, solidFill="FF9800"),   # orange = partial
        DataPoint(idx=2, solidFill="F44336"),   # red = unpaid
    ]
