...
async def export_account_excel(
    ...
    # ── GSTR-2B (Purchase Register) Sheet ────────────────────
    ...
    for inv in sup_invs:
        ...
        sup = await db.get(Supplier, (inv.supplier_mobile, tid))
        sup_gstin = sup.gstin or "" if sup else ""
