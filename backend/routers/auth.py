...
# Limiter instance — shared from main.py via app.state; defined here
# as a module-level reference so decorators below can use it.
# main.py sets app.state.limiter = limiter which slowapi reads automatically.
...
@_limiter.limit("10/minute;30/hour")   # 10 attempts/min, 30/hour per IP
...
@_limiter.limit("15/minute;60/hour")   # slightly higher — Google tokens are short-lived
...
@_limiter.limit("5/minute;20/hour")    # strict — signup is expensive
